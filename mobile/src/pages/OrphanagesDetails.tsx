...
export default function OrphanagesDetails() {
  ...
  function handleOpenGoogleMapRoutes() {
    Linking.openURL(`https://www.google.com/maps/dir/?api=1&origin=1&destination=${orphanage?.latitude},${orphanage?.longitude}`)
  }
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            ...
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>Segunda à Sexta {orphanage.opening_hour}</Text>
          </View>
